...
// Source: ./core/loadpoint (interfaces: API)
//
// Generated by this command:
//
//	mockgen -package loadpoint -destination mock.go -mock_names API=MockAPI ./core/loadpoint API
//
...
func (m *MockAPI) GetPlan(targetTime time.Time, requiredDuration, precondition time.Duration, continuous bool, costLimit *float64) api.Rates {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPlan", targetTime, requiredDuration, precondition, continuous, costLimit)
	ret0, _ := ret[0].(api.Rates)
	return ret0
}

// GetPlan indicates an expected call of GetPlan.
func (mr *MockAPIMockRecorder) GetPlan(targetTime, requiredDuration, precondition, continuous, costLimit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPlan", reflect.TypeOf((*MockAPI)(nil).GetPlan), targetTime, requiredDuration, precondition, continuous, costLimit)
}

// GetPlanCostLimit mocks base method.
func (m *MockAPI) GetPlanCostLimit() *float64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPlanCostLimit")
	ret0, _ := ret[0].(*float64)
	return ret0
}

// GetPlanCostLimit indicates an expected call of GetPlanCostLimit.
func (mr *MockAPIMockRecorder) GetPlanCostLimit() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPlanCostLimit", reflect.TypeOf((*MockAPI)(nil).GetPlanCostLimit))
}
